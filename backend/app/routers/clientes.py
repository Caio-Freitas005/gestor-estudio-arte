...
def create_client(cliente: ClienteCreate, session: SessionDep) -> Cliente:
...
def get_client_by_id(id: int, session: SessionDep) -> Cliente:
...
def delete_client(id: int, session: SessionDep):
    """Remove um cliente."""
